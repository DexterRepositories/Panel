...
wget -qO /etc/banner "https://raw.githubusercontent.com/EskalarteDexter/Autoscript/main/SshBanner"
...
curl -skL "https://raw.githubusercontent.com/DexterRepositories/Panel/main/NEW-PROMO/badvpn-udpgw" -o /usr/local/bin/badvpn-udpgw 
	chmod +x /usr/local/bin/badvpn-udpgw
    # Change link boss ng badvpn-udpgw.service
	curl -skL "https://raw.githubusercontent.com/DexterRepositories/Panel/main/NEW-PROMO/badvpn-udpgw.service" -o /lib/systemd/system/badvpn-udpgw.service
...
function OVPNFixer(){
 ...
 wget -qO /etc/openvpn/ovpn_fixer.bash "https://raw.githubusercontent.com/DexterRepositories/Panel/main/NEW-PROMO/ovpn_fixer.bash"
...
echo -e " \e[92m Stunnel:\e[0m \e[97m: 1194, 8020\e[0m"
echo -e " \e[92m DropbearSSH:\e[0m \e[97m: 550, 555\e[0m"
echo -e " \e[92m OPENVPN PORT:\e[0m \e[97m: 443, 110\e[0m"
echo -e " \e[92m Squid:\e[0m \e[97m: 8000, 8080\e[0m"
echo -e " \e[92m OpenSSH WS:\e[0m \e[97m: 80\e[0m"
echo -e " \e[92m OpenSSL WS:\e[0m \e[97m: 442\e[0m"
...
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/DexterRepositories/Panel/main/NEW-PROMO/prem.sh -q
}
...
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/DexterRepositories/Panel/main/NEW-PROMO/vip.sh -q
}
...
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/DexterRepositories/Panel/main/NEW-PROMO/private.sh -q
}
...
do
    case $opt in
		...
		pythonproxyinstall
		echo -e "\n  \033[1;32mInstalling Websocket!\033[0m"
		service
		echo -e "\n  \033[1;32mInstalling Websocket Service!\033[0m"
		service1
